...
\begin{document}
  ...
  \section{Maximum-entropy interpretation}
    ...
    A route that imposes unit dispersion directly on the discrete triple --- for instance as the singlet--doublet
    equipartition of the cyclic form~\eqref{eq:cyclic}, where three phases $120^\circ$ apart inherit the
    amplitude-fixed dispersion exactly and independently of the phase $\delta$ --- does not incur this transfer, and
    relocates the lock to the amplitude (equipartition) condition itself.
